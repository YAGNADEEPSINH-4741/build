...
export default function Manifesto() {
  ...
  return (
    <section ref={containerRef} id="manifesto" className="relative h-screen flex items-center bg-[#050814] overflow-hidden border-y border-white/5">
      <div 
        ref={textRef} 
      ...
      >
        ...
        <svg className="w-32 h-16 md:w-64 md:h-32 flex-shrink-0 stroke-[#8A2BE2]" viewBox="0 0 200 100" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0,50 C50,100 150,0 200,50" strokeWidth="4" strokeLinecap="round" strokeDasharray="10 15"/>
        </svg>
        ...
        <span className="text-6xl md:text-8xl lg:text-[10rem] font-display font-black outline-text text-transparent tracking-tighter" style={{ WebkitTextStroke: '2px #00f6ff' }}>
          Pixels
        </span>
        
        <div className="w-4 h-4 md:w-8 md:h-8 bg-[#00f6ff] rounded-full flex-shrink-0 shadow-[0_0_20px_#00f6ff]"></div>

        <span className="text-6xl md:text-8xl lg:text-[10rem] font-display font-black outline-text text-transparent tracking-tighter" style={{ WebkitTextStroke: '2px #8A2BE2' }}>
          Performance
        </span>
